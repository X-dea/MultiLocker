...
const uint8_t R308::packHead[6] = {0xEF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF};
const uint8_t R308::packInit[10] = {0x01, 0x00, 0x07, 0x13, 0x00,
                                    0x00, 0x00, 0x00, 0x00, 0x1B};
const uint8_t R308::packGetImg[6] = {0x01, 0x00, 0x03, 0x01, 0x0, 0x05};
const uint8_t R308::packToBuffer1[7] = {0x01, 0x0, 0x04, 0x02, 0x01, 0x0, 0x08};
const uint8_t R308::packToBuffer2[7] = {0x01, 0x0, 0x04, 0x02, 0x02, 0x0, 0x09};
const uint8_t R308::packRegModel[6] = {0x01, 0x0, 0x03, 0x05, 0x0, 0x09};
const uint8_t R308::packEmpty[6] = {0x01, 0x0, 0x03, 0x0d, 0x00, 0x11};
